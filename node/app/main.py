...
from .replicant import router as replication_router, replicate_update_to_peers
...
async def vote(v: VoteIn):
    ...
    - replicate the new component value (idempotent)
    """
...
def get_poll(poll_id: str):
    """
    Query: return aggregated counts (sum of components).
    """
